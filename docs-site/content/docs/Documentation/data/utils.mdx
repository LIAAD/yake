...
Normalizes text by handling line breaks and spacing to prepare for tokenization, preserving paragraph structure by detecting capitalized line beginnings.

**Parameters:**
- `text` (str): The raw input text to be normalized

**Returns:**
- str: Normalized text with standardized whitespace and line breaks
